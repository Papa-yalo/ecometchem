...
const I18N = {
  en: {
    ...
    mat_tab_waste: "Procurement / Sales",
    mat_tab_services: "Partnership & Services",
  ...
  ru: {
    ...
    mat_tab_waste: "Закупаем/Предлагаем",
    mat_tab_services: "Партнёрство и услуги",
  ...
  pl: {
    ...
    mat_tab_waste: "Skup / Sprzedaż",
    mat_tab_services: "Partnerstwo i usługi",
  ...
  de: {
    ...
    mat_tab_waste: "Einkauf / Verkauf",
    mat_tab_services: "Partnerschaft & Leistungen",
  ...
  it: {
    ...
    mat_tab_waste: "Acquisti / Vendite",
    mat_tab_services: "Partnership e servizi",
  ...
  fr: {
    ...
    mat_tab_waste: "Achats / Ventes",
    mat_tab_services: "Partenariat et services",
...
/* Procurement / sales catalog — name stays in English across all languages
   (standard trade practice), photos shown in a lightbox on click. */
const MATERIALS = [
